...
const FeaturesSection = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Respond to all reviews from one place and improve your online reputation with AI-powered responses.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Display your best reviews on your website with customizable review widgets to build trust with potential customers.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section id="features" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <p className="text-base text-orange-600 font-semibold tracking-wide uppercase">Features</p>
        ...
        <div className="mt-16">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => (
              <div 
                key={index} 
                className="flex flex-col p-8 bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-lg transition-shadow duration-300"
              >
                <div className="flex items-center justify-center h-16 w-16 rounded-full bg-orange-100 mb-5">
                  {feature.icon}
                </div>
                <h3 className="text-lg font-medium text-gray-900 mb-3">{feature.title}</h3>
                <p className="text-base text-gray-500 flex-grow">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
